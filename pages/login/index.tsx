...
export default function Login() {
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        ...
        >
          ...
          <p className="text-xl font-light">
            Hyni në llogarinë tuaj duke plotësuar formularin më poshtë.
          </p>
        </motion.section>
  ...
  className="w-full py-2 px-4 bg-red-600 hover:bg-red-700 text-white rounded-xl font-semibold"
>
  Kyçu me Google
</button>
...
>
  Kyçu me Facebook
        ...
        >
          <p>
            Nuk keni llogari?{" "}
            <Link href="/register" className="text-[#526d88] underline">
              Regjistrohuni këtu
            </Link>
          </p>
        </motion.section>
